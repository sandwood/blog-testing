...
import {showUpdateModal, showDetailModal} from "../../actions/modals";
    ...
    return (
      <Modal className="modalEditPost" open={open} size={"small"}>
        <Icon
          ...
          name="close"
          floated="right"
          onClick={this.onClickUpdateModalClose}/>
        <Modal.Header>
          <h2>포스트 수정</h2>
        </Modal.Header>
...
UpdatePostModal.propTypes = {
  pass: PropTypes
    .arrayOf(PropTypes.shape({_id: PropTypes.string.isRequired, title: PropTypes.string.isRequired, content: PropTypes.string.isRequired, imgURL: PropTypes.string.isRequired}).isRequired)
    .isRequired,
...
export default connect(null, {showUpdateModal, showDetailModal})(UpdatePostModal);